...
class GenerateDnsEntry:
    ...
    def start(self, db_session: sqlalchemy.orm.Session, entry_text):
        ...
        try:
            ...
            ns_dns_entry = Database.DNSEntry()
            ...
            ns_a_dns_entry = Database.DNSEntry()
            ...
            ns_a_dns_entry.record_data = {"server_id":   self.dict_server_config['id'],
                                          "domain_name": self.dict_server_config['hostname']}
            ns_aaaa_dns_entry = Database.DNSEntry()
