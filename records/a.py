    ...
    def handle_request(self, dns_request, database: Database, address, sock):
        ...
        try:
            ...
            if query_exists:
                ...
                if query_authority:
                    if query_authority[0].record_data['domain_name'] == self.dict_server_config['hostname']:
                        ...
                        dns_query = self.db_session.query(Database.DNSEntry)\
                            .filter(Database.DNSEntry.entry_text == query)\
                            .filter(Database.DNSEntry.record_type == 1).all()
                ...
                result_generate_dns_entry = self.generate_dns_entry.start(self.db_session, query)
            ...
            print("Error with A. IP:{}|Request URL:{}|Error: {}".format(address, query, str(e)), file=sys.stderr)
